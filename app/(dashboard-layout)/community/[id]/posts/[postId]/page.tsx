...
import {
  ...
  commentsState,
  currentUserState
} from "@/app/community/lib/recoilAtoms";
import CommentCard from "@/app/community/components/CommentCard";
import Link from "next/link";
import { formatDate } from "@/app/community/lib/utils";
import { useRecoilValueCompat, useSetRecoilStateCompat } from "@/app/community/lib/recoil-compat";
import type { Community, Post, Comment, User } from "@/app/community/lib/types";
          ...
          <div className="mb-6 rounded-lg border bg-white p-4 dark:border-gray-700 dark:bg-gray-800">
            ...
            <div className="flex justify-end">
              <button
                ...
                className="rounded-lg bg-blue-600 px-4 py-2 text-white hover:bg-blue-700 disabled:cursor-not-allowed disabled:bg-blue-300 dark:disabled:bg-blue-900">
                Post Comment
              </button>
            </div>
          </div>
        ) : (
          <div className="mb-6 rounded-lg border bg-gray-50 p-4 text-center dark:border-gray-700 dark:bg-gray-800">
