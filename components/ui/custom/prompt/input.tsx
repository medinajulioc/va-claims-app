...
function PromptInputTextarea({
  ...
  return (
    <Textarea
      ...
      className={cn(
        "text-primary dark:bg-background min-h-[44px] w-full resize-none border-none bg-transparent shadow-none outline-none focus-visible:ring-0 focus-visible:ring-offset-0",
        className
      )}
      rows={1}
      disabled={disabled}
